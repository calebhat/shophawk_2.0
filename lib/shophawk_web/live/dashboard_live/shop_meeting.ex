    ...
    ~H"""
      ...
      <div class="grid grid-cols-1 place-content-center text-stone-100">
        ...
        <.live_component module={HotjobsFullScreenComponent} id="hot_jobs-1"
          hot_jobs={@hot_jobs}
          height={%{border: "h-[800px]", frame: "h-[88%]", style: "font-size: 1.25vw"}}
          header_font_size="text-[2.5vw] truncate"
        />
        <br><br><br><br>
      ...
      <.showjob_modal :if={@live_action in [:show_job]} id="runlist-job-modal" show on_cancel={JS.patch(~p"/dashboard/shop_meeting")}>
      <.live_component
