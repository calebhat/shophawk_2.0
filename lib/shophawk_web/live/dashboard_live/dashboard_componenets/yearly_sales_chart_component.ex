      ...
      <div class={["text-center justify-center rounded p-4 bg-cyan-900 m-2", @height.border]}>
        ...
        <% else %>
            <div class="grid grid-cols-3 text-4xl">
              <div class="border-b border-stone-400 rounded-lg text-[1.5vw] truncate">Total Sales</div>
              <div class="border-b border-stone-400 rounded-lg text-[1.5vw] truncate">Controls</div>
              <div class="border-b border-stone-400 rounded-lg text-[1.5vw] truncate">Date Range</div>
              <div class=" text-[1.5vw] truncate"><%= number_to_currency(@total_sales) %></div>
